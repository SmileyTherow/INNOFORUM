    ...
    <div class="alert alert-warning border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #fff3cd 0%, #ffe69c 100%);">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="mb-0 small">Terdapat {{ $reportedThreads->total() }} pertanyaan yang dilaporkan dan memerlukan tindakan Anda.</p>
            </div>
        </div>
    </div>
    @endif
                        ...
                        <tr class="border-bottom">
                                ...
                                <a href="{{ route('questions.show', $thread->id) }}"
                                   ...
                                   class="text-decoration-none">
                                    <div class="font-weight-bold text-primary mb-1" style="font-size: 0.9rem;">
                                        <i class="fas fa-external-link-alt mr-1 small"></i>{{ Str::limit($thread->title, 50) }}
                                    </div>
                                </a>
                            </td>
                            <td class="align-middle">
                            ...
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="font-weight-medium small">{{ $thread->user ? $thread->user->name : '-' }}</span>
                                </div>
                            </td>
                            <td class="align-middle">
                                    ...
                                    <div class="accordion-item border rounded">
                                        <h2 class="accordion-header" id="heading-{{ $thread->id }}">
                                            <button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse"
                                                ...
                                                <span class="badge badge-danger ml-2">{{ $thread->reports->count() }}</span>
                                            </button>
                                        </h2>
        ...
        <div class="card-footer bg-white border-top">
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-muted small">
                    Menampilkan {{ $reportedThreads->firstItem() }} - {{ $reportedThreads->lastItem() }} dari {{ $reportedThreads->total() }} laporan
                </div>
                <div>
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header text-white border-0" style="background: linear-gradient(135deg, #f6ad55 0%, #ed8936 100%);">
                <h5 class="modal-title font-weight-bold">
                    <i class="fas fa-paper-plane mr-2"></i>Kirim Pesan ke {{ $thread->user ? $thread->user->name : 'User' }}
                </h5>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-warning border-0 mb-3" style="background-color: #fff3cd;">
                        <div class="d-flex align-items-center">
                            ...
                            <small>Pertanyaan ini telah dilaporkan <strong>{{ $thread->reports->count() }} kali</strong></small>
                        </div>
                    </div>
