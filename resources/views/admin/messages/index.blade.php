                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @foreach($messages as $m)
                            <tr class="@if(!$m->is_read) bg-light @endif" style="@if(!$m->is_read) border-left: 4px solid #0d6efd; @endif">
                                <td class="px-4">
                                ...
                                <td class="px-4">
                                    @if($m->status == 'terbaca')
                                        <span class="badge bg-success rounded-pill">Terbaca</span>
                                    @else
                                        <span class="badge bg-secondary rounded-pill">Belum Dibaca</span>
                                    @endif
                                </td>
                                <td class="px-4">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form action="{{ route('admin.messages.destroy', $m->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
