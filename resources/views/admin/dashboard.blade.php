    ...
    <div class="container-fluid px-4">
            ...
            <div class="container-fluid py-5">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <p class="lead mb-4 opacity-90">Selamat datang kembali, <strong>{{ Auth::user()->name }}</strong>!
                            Berikut adalah informasi terbaru tentang INNOFORUM hari ini.</p>
                ...
                <a href="{{ route('admin.threads.index') }}" class="text-decoration-none">
                    <div class="card card-hover border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="card-title text-muted text-uppercase small fw-semibold mb-2">Total Pertanyaan
                                    </h6>
                ...
                <a href="{{ route('admin.categories.index') }}" class="text-decoration-none">
                    <div class="card card-hover border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="card-title text-muted text-uppercase small fw-semibold mb-2">Total Kategori
                                    </h6>
                ...
                <a href="{{ route('admin.comments.index') }}" class="text-decoration-none">
                    <div class="card card-hover border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="card-title text-muted text-uppercase small fw-semibold mb-2">Total Komentar
                                    </h6>
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="{{ route('admin.threads.reported') }}"
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.messages.index') }}"
                                    class="btn btn-outline-info w-100 h-100 py-3 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.stats.index') }}"
                                    class="btn btn-outline-warning w-100 h-100 py-3 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="col-xl-6">
                <div class="card border-0 shadow-sm h-100">
                    <div
                        class="card-header bg-transparent py-3 border-0 d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0 fw-semibold">
                            <i class="fas fa-history text-info me-2"></i>
                            Aktivitas Admin Terbaru
                        </h5>
                        <a href="{{ route('admin.activities.index') }}" class="btn btn-sm btn-outline-primary">Lihat
                            Semua</a>
                    </div>
                    <div class="card-body p-0">
                        <div class="activity-list" style="max-height: 400px; overflow-y: auto;">
                            @forelse($recentActivities as $activity)
                                <div class="activity-item border-bottom p-4 hover-bg-light">
                                    <div class="d-flex align-items-start">
                                        <div class="flex-shrink-0 me-3">
                                            @php
                                                $admin = $activity->admin;
                                                $avatar = $admin->avatar ?? '';
                                                $name = $admin->name ?? ($activity->admin_name ?? 'System');
                                            @endphp
                                            @if ($avatar)
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="text-gray-800 mb-2 small">
                                                {{ $activity->description ?? ($activity->action ?? 'Aktivitas tidak tersedia') }}
                                            </p>

                                            @if ($activity->note)
                                                <div
                                                    class="bg-warning bg-opacity-10 rounded p-2 mb-2 border-start border-warning border-3">
                            ...
                            @empty
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted small mb-0">Aktivitas admin akan muncul di sini</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
