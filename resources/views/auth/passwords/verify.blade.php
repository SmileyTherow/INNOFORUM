    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md overflow-hidden border border-gray-700">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                ...
                <p class="text-blue-100 mt-2">Masukkan kode yang dikirim ke email Anda</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('password.verify.post') }}">
                    ...
                    <div class="mb-6">
                        <label class="block text-gray-300 mb-2 font-medium">Kode Verifikasi (6 digit)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-lock text-gray-500"></i>
                            </div>
                            <input name="code" type="text" maxlength="6" value="{{ old('code') }}" required
                                class="w-full pl-10 p-3 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-white placeholder-gray-400 text-center tracking-widest font-mono text-lg">
                        </div>
                        @error('code')
                            <div class="mt-2 text-red-400 text-sm flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                ...
                <div class="mt-6 p-4 bg-blue-900/30 rounded-lg border border-blue-800">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-300">Kode verifikasi akan kadaluarsa dalam 15 menit</p>
                        </div>
                    </div>
                </div>
