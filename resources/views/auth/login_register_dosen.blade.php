                    ...
                    <form id="form-signup" method="post" action="{{ route('register.process') }}"
                        ...
                        <div class="form-element form-stack">
                            ...
                            <input id="prodi" type="text" name="prodi"
                                placeholder="Contoh: Algoritma Pemrograman, Struktur Data, Basis Data"required>
                        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">
                    <span>💁</span>
                    Pusat Bantuan Login & Registrasi Dosen
                </h2>
                <button class="close-modal" onclick="closeHelpModal()">&times;</button>
            </div>
            <div class="help-content">
                <div class="help-section">
                    <h3><span>👨‍🏫</span> Proses Registrasi Dosen</h3>
                    <p>Untuk mendaftar sebagai dosen, pastikan:</p>
                    <ul class="help-list">
                        ...
                        <li>Masukkan mata kuliah yang diampu dengan benar</li>
                        <li>Foto profil opsional (format JPG/PNG, max 2MB)</li>
                    </ul>
                </div>

                <div class="help-section">
                    <h3><span>🔐</span> Proses Login Dosen</h3>
                    <p>Masuk dengan akun dosen yang sudah terdaftar:</p>
                    <ul class="help-list">
                        <li>Gunakan email yang didaftarkan saat registrasi</li>
                ...
                <div class="help-section">
                    <h3><span>📚</span> Informasi Mata Kuliah</h3>
                    <p>Pengisian mata kuliah yang diampu:</p>
                    <ul class="help-list">
                        <li>Masukkan semua mata kuliah yang diampu</li>
                        <li>Pisahkan dengan koma jika lebih dari satu mata kuliah
                            Contoh: "Algoritma Pemrograman, Struktur Data, Basis Data"</li>
                    </ul>
                </div>

                <div class="help-section">
                    <h3><span>⚠️</span> Troubleshooting Khusus Dosen</h3>
                    <ul class="help-list">
                        <li>Email sudah terdaftar? Gunakan email lain atau login</li>
                        <li>Akun belum aktif? Tunggu verifikasi dari admin</li>
                        <li>Lupa password? Hubungi admin untuk reset</li>
                        <li>File foto terlalu besar? Kompres terlebih dahulu</li>
                        <li>Mata kuliah tidak sesuai? Edit profil setelah login</li>
                    </ul>
                </div>
